...
<head>
  <meta charset="UTF-8">
  <title>CodePen - Log in/Sign up screen animation</title>
...
<div class="container">
  <div class="frame">
    ...
    <div ng-app ng-init="checked = false">
          ...
          <input class="form-styling" type="username" name="username" placeholder=""/>
          <label for="email">Email</label>
          <input class="form-styling" type="email" name="email" placeholder=""/>
          <label for="password">Password</label>
          <input class="form-styling" type="password" name="password" placeholder=""/>
          <label for="confirmpassword">Confirm password</label>
          <input class="form-styling" type="confirmpassword" name="confirmpassword" placeholder=""/>
...
<script src='//cdnjs.cloudflare.com/ajax/libs/angular.js/1.3.14/angular.min.js'></script><script  src="./script.js"></script>
