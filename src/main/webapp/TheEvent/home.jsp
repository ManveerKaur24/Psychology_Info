...
<header id="header" class="d-flex align-items-center ">
    <div class="container-fluid container-xxl d-flex align-items-center">
      ...
      <div id="logo" class="me-auto">
        ...
        <a href="home.jsp" class="scrollto"><img src="assets/img/logo.png" alt="" title=""></a>
      </div>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
       <%
                                ...
                                {
                                	%>
                                	 <li>Hi <%=session.getAttribute("user") %></li>
                                ...
                                {
                                	%>
                                	 <li class="nav-item"><a class="nav-link" href="Signup.jsp">Hi Guest</a></li>
                                	  <li class="nav-item"><a class="nav-link" href="Signup.jsp">Login</a></li>
                                	<%
